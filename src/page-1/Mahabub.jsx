...
const Mahabub = () => {
    ...
    const [value, setValue] = useState(`<div id="myZadarmaCallmeWidget13328"></div>
    <script>
    ...
    return (
        <div>
                    ...
                    <div>
                        ...
                        <label className='m-8'>
                            <textarea
                                ...
                                name="postContent"
                                defaultValue="<div id='zadarmaScripts'></div>
                <script>
                    (function() {
            ...
            <div>
                ...
                <button className="flex gap-4 items-center justify-center bg-teal-400 mx-8 m-8" id='callButton'>
                    ...
                    <span className='text-white text-2xl' id='colorChange'>Call Us</span>
                </button>
            </div>
        </div>
    );
