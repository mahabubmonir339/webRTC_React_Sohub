            ...
            <div><br /><br />
                ...
                <div className=''>
                    ...
                    <div className='flex flex gap-5 flex-wrap justify-center content-center'>
                        <Link to='/widget_integration'><button className="btn btn-sm btn-success">Create</button></Link>
                        <Link to='/click_to_call_button'><button className="btn btn-sm btn-danger mx-5" onClick={fixedColor => (currentColor, currentTextColor)}>Cancel</button></Link>
                    </div>
                </div>
            </div>
        </div>
